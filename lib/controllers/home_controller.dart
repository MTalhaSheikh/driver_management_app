...
//     // Filter by date (only show trips matching selected date)
...
//     // Sort by pickup time
//     filtered.sort((a, b) => a.pickupTime.compareTo(b.pickupTime));
...
//       return 'Yesterday';
//     } else {
//       return DateFormat('MMM dd').format(selectedDate.value);
//     }
//   }
